// components/ui/AssignPhotographers.tsx
"use client";
...
import { updateBookingAssignments } from "@/lib/actions";

interface AssignPhotographersProps {
  bookingId: number;
...
export function AssignPhotographers({ 
  ...
  const handleAssign = async () => {
    ...
    try {
      const result = await updateBookingAssignments(bookingId, selectedStaff);
      ...
      if (result.error) {
        ...
        toast.success("Staff Assigned", {
          description: `Updated assignments for this booking.`,
        });
        setIsOpen(false);
      }
    } catch {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Select team members to assign to this booking.
          </DialogDescription>
        </DialogHeader>
