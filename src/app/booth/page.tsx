...
import { DeleteEventButton } from "@/components/booth/DeleteButtons"; // <--- Import
          ...
          <div className="grid gap-3 md:gap-4">
            {events?.map((event) => (
              <Link key={event.id} href={`/booth/${event.id}`}>
                <Card className="bg-card/50 backdrop-blur-sm border-white/10 hover:bg-white/5 transition-all group relative">
